...
// This macro is a plain copy of $ROOTSYS/tutorials/tree/printSizes.C with slight modifications
...
void printTreeSummary(TTree *t)
{
   ...
   cout << "  Its size is " << t->GetEntries() << ", i.e. " << sizeOnDisk(t)/t->GetEntries() << " per event.\n";
