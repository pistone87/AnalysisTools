...
TauSpinerInt.SetTauSignalCharge(signalcharge);
  ...
  bool isVtxGood_muJets(unsigned int i); //claudia
  ...
  bool           isGoodMuon_muJets(unsigned int i); //claudia
  bool           isGoodMuon_nooverlapremoval_muJets(unsigned int i); //claudia
